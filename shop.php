...
<html lang="zxx">
   <head>
      ...
      <meta charset="utf-8" />
      <meta name="glasses, eyeglasses, sunglasses, eyewear, prescription lenses, affordable glasses, stylish eyewear, buy glasses online, Glasses Hub" content="Discover a wide range of stylish and affordable glasses at Glasses Hub. Shop the latest eyeglasses, sunglasses, and prescription lenses for men, women, and kids. Fast shipping and top-quality eyewear guaranteed!"
         />
      <script>
         addEventListener(
             "load",
   ...
   <body>
      <div class="banner-top container-fluid" id="home">
         ...
         <!-- <marquee behavior="scroll" direction="left" class="marquee">
            <span>New Arrivals:</span> Ray-Ban, Oakley, Prada, Persol, and more!
            <span>Shop Now!</span> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Need Help
            &nbsp;<span><i class="fas fa-phone"></i>&nbsp; </span>Call +923532145671
            </marquee> -->
         <!-- //marque -->
         <div class="header-section__upper" data-header-upper="">
            <div class="container-fluid">
               <div class="header-section__row">
                  <p class="label">
                     Redefining vision with timeless style and clarity since 2024.
                  </p>
                  <ul>
                     <li>
                        <a href="blogs.html" class="link link--alt">Blogs</a>
                     </li>
                     <li>
                        <a href="contact.html" class="link link--alt">Contact</a>
                     </li>
                  </ul>
               </div>
            </div>
         ...
         <div class="cart-menu">
            ...
            <div class="side-menu-cart">
               <main>
                  ...
                  <ul class="products">
                     <li class="product">
                        <a href="#" class="product-link">
                           ...
                           <img
                              src="https://via.placeholder.com/75x50/ffffff/cccccc?text=PHOTO"
                              alt="Product Photo"
                              />
                           </span>
                  ...
                  <div class="totals">
                     <div class="subtotal">
                        <div class="checkout-here">
                           <span class="label">Subtotal:</span>
                           <span class="amount">$54.00</span>
                        </div>
                     </div>
                     <a class="checkout-button hover-filled-slide-right" href="">
                     <span>Cart</span>
                     </a>
                  </div>
               </main>
         ...
         <div class="overlay-login text-left">
            ...
            <div class="wrap">
               ...
               <div class="login p-5 bg-f2f2f2 mx-auto mw-100">
      ...
      <div class="banner_inner">
         <div class="services-breadcrumb">
            ...
            <h3 style="display: inline-block; color:black" class="p-5">
            Find Glasses that <br>Suit Your Style and Vision</h6>
         </div>
      ...
      <section class="banner-bottom-wthreelayouts">
         <div class="container-fluid">
            <div class="inner-sec-shop">
               ...
               <div class="row">
                  <!-- product left -->
                  <div class="side-bar sidebar-desktop col-lg-3 px-3 py-3">
                  ...
                  <div class="left-ads-display col-lg-9 mt-5">
                     <div class="wrapper_top_shop pt-3">
                        ...
                        <!-- <div
                           class="col-md-12 shop_left rock-girl-container"
                           data-aos="fade-up"
                           data-aos-delay="50"
                                 ...
                                 <div class="container-fluid">
                                    ...
                                    <div class="row ">
                                       <div class="col-lg-12 d-flex justify-content-center py-3 ">
                                             <h4 class="navbar-brand mx-auto text-muted">Glasses Hub</h4>
                                          <button type="button" class="overlay-close" style="top: 17px;">
                                          <i class="fa fa-times" aria-hidden="true"></i>
                                          </button>
                                       </div>
                                       ...
                                       <!-- <div class="col-lg-6 bg-light col-sm-12 h-100">
                                       </div> -->
                                       ...
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/s1.jpg" alt=""/>
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Farenheit</span>
                                    ...
                                    <div class="page-wrapper">
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/s2.jpg" alt="" />
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Opium</span>
                                                         <span class="p-company">Grey</span>
                                                      </div>
                                                      <div class="a-size">
                                                         <div>
                                    ...
                                    <div class="page-wrapper">
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/s3.jpg" alt="" />
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Farenheit</span>
                                                         <span class="p-company">Grey</span>
                                    ...
                                    <div class="page-wrapper">
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/s4.jpg" alt="" />
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Farenheit</span>
                                                         <span class="p-company">Grey</span>
                                    ...
                                    <div class="page-wrapper">
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/m1.jpg" alt="" />
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Farenheit</span>
                                                         <span class="p-company">Grey</span>
                                    ...
                                    <div class="page-wrapper">
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/m2.jpg" alt="" />
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Farenheit</span>
                                                         <span class="p-company">Grey</span>
                                    ...
                                    <div class="page-wrapper">
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/m3.jpg" alt="" />
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Farenheit</span>
                                                         <span class="p-company">Grey</span>
                                    ...
                                    <div class="page-wrapper">
                                       <div class="page-inner">
                                          <div class="row">
                                             <div class="el-wrapper">
                                                <div class="box-up">
                                                   <img class="img" src="images/m4.jpg" alt="" />
                                                   <div class="img-info">
                                                      <div class="info-inner">
                                                         <span class="p-name">Farenheit</span>
                                                         <span class="p-company">Grey</span>
               ...
               <div class="slider-img mid-sec mt-lg-5 mt-2">
                  <!--//banner-sec-->
                  <h3 class="tittle-w3layouts text-left my-lg-4 my-3">
                     Featured Products
                  </h3>
         ...
         <div class="container-fluid px-lg-5 px-3">
            ...
            <div class="copyright-w3layouts mt-4">
               <p class="copy-right text-center">
                  &copy; 2024 Glasses Hub. All Rights Reserved | Design by
                  <a href="https://webnetpk.com/"> Webnet Pakistan Pvt Ltd.</a>
               </p>
            </div>
         </div>
      </footer>
      ...
      <script>
         $(document).ready(function () {
           ...
           $(".cart-menu .cancel").click(function () {
      ...
      <script>
         $(document).ready(function () {
           ...
           $(".color-btn").click(function () {
             ...
             $(".colors-container .color").removeClass("active");
