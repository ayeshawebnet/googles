						...
						<div class="d-flex ">
							...
							<form class="form-inline header-searchbar">
								<span class="search-icon">
									<svg color="#000" focusable="false" width="15" height="15"
								...
								<input class="form-control header-search" type="search" placeholder="Search Products"
									aria-label="Search" />
							</form>
								...
								<ul class="cart-inner-info">
										...
										<a class="btn-open nav-link" href="#">
											<svg focusable="false" width="18" height="17"
												...
												<circle cx="9" cy="5" r="4" fill="none" stroke="currentColor"
													stroke-width="1.4" stroke-linejoin="round"></circle>
									...
									<li class="galssescart galssescart2 cart cart box_1">
										<a class="nav-link open-cart" role="button">
											<svg color="#000" focusable="false" width="20" height="18"
						...
						<li class="product">
							<a href="#" class="product-link">
								<span class="product-image">
									<img src="https://via.placeholder.com/75x50/ffffff/cccccc?text=PHOTO"
										alt="Product Photo" />
								</span>
								<span class="product-details">
									...
									<span class="qty-price">
										<span class="qty">
											...
											<input type="number" id="qty-input-1" class="qty-input" step="1" min="1"
												max="1000" name="qty-input" value="1" pattern="[0-9]*" title="Quantity"
												inputmode="numeric" />
							...
							<a href="#remove" class="remove-button"><span class="remove-icon">
								...
								<span class="product-details">
									...
									<span class="qty-price">
										<span class="qty">
											...
											<input type="number" id="qty-input-2" class="qty-input" step="1" min="1"
												max="1000" name="qty-input" value="1" pattern="[0-9]*" title="Quantity"
												inputmode="numeric" />
											<button class="plus-button" id="plus-button-1">
												+
